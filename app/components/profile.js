    ...
    didInsertElement() {
      ...
      //    markers: true
        ...
        const tl = gsap.timeline({
          ...
          .fromTo('#profile-section .text-reveal',
          ...
          const camera  = new THREE.PerspectiveCamera(100, sceneContainer.clientWidth / sceneContainer.clientHeight, 0.1, 1000)
          ...
          function onWindowResize() {
            ...
            console.log("🚀 ~ ProfileComponent ~ onWindowResize ~ width:", width)
